...
const getUrl = (coors) => {
  ...
  const url = `https://api.mapbox.com/directions/v5/mapbox/driving/${coorString}?geometries=geojson&access_token=pk.eyJ1IjoiZXJpY3lhcmhhbSIsImEiOiJjbGVtdWN2MHIwMDE2M3hsazA2aGt0YXN3In0.62ElsBzews_TTWShyekDUQ`
  return url;
